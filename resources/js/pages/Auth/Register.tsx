                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                <User className="absolute top-1/2 left-0 h-4 w-4 -translate-y-1/2 text-[#6C6863]" />
                                <input
                                    type="text"
                                    value={formData.name}
                                    onChange={(e) =>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full border-b border-[#1A1A1A]/20 bg-transparent py-2 pl-6 font-sans text-sm text-[#1A1A1A] transition-colors duration-500 focus:border-[#D4AF37] focus:outline-none"
                                    placeholder="juan.dela Cruz@asc.edu.ph"
                                    required
                                />
                            </div>
                            {errors.email && (
                        ...
                        {errors.general && (
                            <div className="mt-2 font-sans text-xs text-red-600">
                                {errors.general[0]}
                            </div>
                        )}
