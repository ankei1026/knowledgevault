        ...
        <AppLayout>
            ...
            <div className="mb-10">
                ...
                <p className="drop-cap max-w-2xl font-sans text-base leading-relaxed text-[#6C6863]">
                    Manage your capstone manuscripts, track review status, and
                    access your research documents.
                </p>
            </div>
            ...
            <div className="mb-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {statCards.map((card, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`group ${card.bgClass} border-t-2 pt-5 transition-all duration-700 hover:bg-[#F9F8F6]/50`}
                        >
                ...
                <div className="mb-8 border border-yellow-200 bg-yellow-50 p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            ...
                            className="font-sans text-xs text-yellow-800 underline hover:text-yellow-900"
                        >
                            View Details
                        </Link>
                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <ChevronRight className="h-4 w-4 text-[#6C6863] opacity-0 transition-all duration-500 group-hover:opacity-100" />
                                        </div>
                                    </Link>
                                </div>
                            ))}
                            ...
                            {recentDocuments.length === 0 && (
                                <div className="py-8 text-center">
                                    ...
                                    <Link
                                        ...
                                        className="mt-3 inline-flex items-center gap-2 text-xs text-[#D4AF37] transition-colors hover:text-[#1A1A1A]"
                                    >
                    ...
                    <div className="border border-[#1A1A1A]/10 p-6">
                        ...
                        <div className="space-y-3">
                            {recentActivity.map((activity, index) => (
                                <div
                                    key={index}
                                    className="flex items-start gap-3 border-l-2 border-[#D4AF37]/30 pl-3"
                                >
                                    <div className="flex-1">
                                        <p className="font-sans text-sm text-[#1A1A1A]">
                            ...
                            {recentActivity.length === 0 && (
                                <div className="py-8 text-center">
                                    <TrendingUp className="mx-auto h-8 w-8 text-[#6C6863]/30" />
                                    <p className="mt-2 font-sans text-sm text-[#6C6863]">
                                        No recent activity
                                    </p>
                                </div>
            ...
            <div className="border-t border-[#1A1A1A]/10 pt-8">
                <div className="flex flex-wrap gap-4">
                    <Link
                        href="/student/documents/upload"
                        className="group relative inline-flex h-11 items-center overflow-hidden bg-[#1A1A1A] px-6 transition-shadow duration-500 hover:shadow-[0_8px_24px_rgba(0,0,0,0.25)]"
                    >
                    ...
                    <Link
                        href="/student/library"
                        className="inline-flex h-11 items-center gap-2 border border-[#1A1A1A] px-6 font-sans text-xs tracking-[0.2em] text-[#1A1A1A] transition-all duration-500 hover:bg-[#1A1A1A] hover:text-white"
                    >
